return {
  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      -- disable ruff hover, since using with Pyright
      vim.api.nvim_create_autocmd('LspAttach', {
      ...
      -- NOTE: This is a hack to disable biome diagnostics when it is active
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(args)
          ...
          -- Optional key to organize imports (Biome provides a code action for it)
